python -m Openeval.run infer \
  --data "Openeval/datasets/formatted_data/codeforces.jsonl/codeforces.jsonl" \
  --batch_size 8 \
  --endpoint http://10.200.250.35:7005/generate \
  --prediction_dir predictions/qwen2.5_instruct_7b \
  --sampling_params '{"temperature":0.9,"top_p":0.85,"max_tokens":8192,"n":5,"presence_penalty":0.8,"repetition_penalty":0.8}' \
  --loglevel INFO \
